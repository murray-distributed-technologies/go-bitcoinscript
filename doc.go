...
// This file has been modified to remove fork-specific branding - galt-tr

/*
Package bitcoinscript implements the bitcoin transaction script language.
...
information is used to prove the the spender is authorized to perform the
transaction.
...
Errors returned by this package are of type bitcoinscript.Error.  This allows the
caller to programmatically determine the specific error by examining the
ErrorCode field of the type asserted bitcoinscript.Error while still providing rich
