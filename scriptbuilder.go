...
// 	builder := bitcoinscript.NewScriptBuilder()
// 	builder.AddOp(bitcoinscript.OP_2).AddData(pubKey1).AddData(pubKey2)
// 	builder.AddData(pubKey3).AddOp(bitcoinscript.OP_3)
// 	builder.AddOp(bitcoinscript.OP_CHECKMULTISIG)
...
func (b *ScriptBuilder) Error() error {
	return b.err
}

func (b *ScriptBuilder) SetScript(s []byte) {
	b.script = s
}
