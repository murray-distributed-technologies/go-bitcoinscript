...
const (
	...
	// ErrOperandSize is returned if the sizes of the inputs do not match
	ErrOperandSize
	...
	// ErrScriptNumOverflow is returned when the input exceeds max number of
	// bytes for scriptnum
	ErrScriptNumOverflow

	// ErrSplitRange is returned when OP_SPLIT is called with n outside range of
	// length of input
	ErrSplitRange
	...
	// ErrDivByZero is returned when OP_DIV attempts to divide by zero
	ErrDivByZero

	// ErrModByZero is returned when OP_MOD attempts to divide by zero
	ErrModByZero

	// ErrInvalidNumberRange is returned when the argument is not within a valid
	// numeric range
...
var errorCodeStrings = map[ErrorCode]string{
	...
	ErrScriptNumOverflow:        "ErrScriptNumOverflow",
	ErrSplitRange:               "ErrSplitRange",
