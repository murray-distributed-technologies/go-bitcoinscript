...
func TestMakeScriptNum(t *testing.T) {
	...
	errScriptNumOverflow := scriptError(ErrScriptNumOverflow, "")
	...
	tests := []struct {
		...
		{hexToBytes("0000008000"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("0000008080"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("0000009000"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("0000009080"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("ffffffff00"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("ffffffff80"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("0000000001"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("0000000081"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("ffffffffffff00"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("ffffffffffff80"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("ffffffffffffff00"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("ffffffffffffff80"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("ffffffffffffff7f"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
		{hexToBytes("ffffffffffffffff"), 0, defaultScriptNumLen, true, errScriptNumOverflow},
